...
public class CandidateServiceImpl implements CandidateService {
    ...
    @Override
    public CandidatesDTO saveAll(BatchCandidatesCreateRequest requests) {
        List<Candidate> candidates = requests.getCandidates().stream()
                .map(request -> {
        ...
        return new CandidatesDTO(candidates.stream()
                .map(mapper::toDTO)
                .toList());
    }
